    ...
    <div className='blog'>
        ...
        <div className='blogContainer'>
          ...
          <div className='blogThumbnailUpload'>
                ...
                <input type="file" id="file" style={{ display: "Choose File" }} />
              </div>
        </div>
